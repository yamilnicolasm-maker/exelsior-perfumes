      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="space-y-8 z-10">
          <div className="space-y-3">
            <h2 className="text-red-500 text-sm font-bold tracking-widest uppercase">
              Perfumes de Lujo
            </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <a
              href="#perfumes"
              className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg text-center"
            >
              Ver Catalogo
            </a>
            <button
              onClick={handleWhatsApp}
              className="border-2 border-red-500 text-red-400 hover:bg-red-900/20 hover:text-red-300 font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"
            >
              Consultar por WhatsApp
            </button>
          </div>

          <div className="flex flex-wrap gap-8 pt-8 border-t border-red-900/30">
            <div className="space-y-1">
              <p className="text-2xl font-bold text-red-500">50+</p>
              <p className="text-sm text-gray-400">Fragancias premium</p>
            </div>
            <div className="space-y-1">
              <p className="text-2xl font-bold text-red-500">100%</p>
              <p className="text-sm text-gray-400">Esencias arabes</p>
            </div>
            <div className="space-y-1">
              <p className="text-2xl font-bold text-red-500">24/7</p>
              <p className="text-sm text-gray-400">Atencion personal</p>
            </div>
            <div className="space-y-1">
              <p className="text-2xl font-bold text-red-500">ARG</p>
              <p className="text-sm text-gray-400">Envios a todo el pais</p>
            </div>
          </div>
        </div>
